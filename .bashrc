...
alias a="test -d venv && source venv/bin/activate || echo 'No Virtualenv in the current folder'"
alias mkenv='test -d venv && echo "Already exists" || python -m venv venv && ./venv/bin/activate'

alias nvim="$HOME/bin/nvim.appimage"

alias edit="vi $HOME/.config/i3/config" 
